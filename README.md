...
| 2026-09-03 | [Boosting Program Reduction with the Missing Piece of Syntax-Guided Transformations (SFC)](papers/2025-sfc/) | OOPSLA 2025 | scoped L1 minimization results + scoped L2 current-Perses mechanism | `paper-sfc.yml` |
